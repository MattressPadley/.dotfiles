...
export TRANS_BAR_COLOR=0xcc24273a
export TRANS_POPUP_COLOR=0xb3363a4f
...
export BACKGROUND_2=$CRUST  
export BACKGROUND_1=$TRANSPARENT
export ICON_COLOR=$HIGHLIGHT_COLOR # Color of all icons
export ICON_HIGHLIGHT_COLOR=$SURFACE0
export LABEL_COLOR=$HIGHLIGHT_COLOR # Color of all labels
export LABEL_HIGHLIGHT_COLOR=$SURFACE0
export POPUP_BACKGROUND_COLOR=$TRANS_POPUP_COLOR
